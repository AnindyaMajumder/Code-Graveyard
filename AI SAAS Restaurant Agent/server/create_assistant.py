...
def create_assistant(voice="matilda", restaurant_name="MadChef", speed=1.0, webhook_url="https://lkkjlk.ngrok-free.app/vapi-webhook/", restaurant_no="+477"): 
    if speed<0.7:
        speed = 0.7
    elif speed>1.2:
        speed = 1.2
...
- Ensure menu descriptions, if provided, are translated into German for German-speaking users, using natural and accurate culinary terms. 
            """
    Reservation = "028ed3719d"
    Get_Restaurant_Info = "b37ac6399bccb54c0"
    OrderCreate = "7e0f8c63f49bca41"
    CustomerService = "2516e06a14045"
