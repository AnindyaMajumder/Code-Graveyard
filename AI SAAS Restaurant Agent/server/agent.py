...
class AGENT:
    ...
    def __create_assistant(self, voice="matilda", restaurant_name="Garlic and Ginger", speed=1.0, webhook_url="https://76.ngrok-free.app/vapi-webhook", restaurant_fallback="+88791025"):
        try:
    ...
    def __create_number(self, twillo_num="+1662487", ssid="ggjkgjgkgjgh", restaurant_fallback="+8801615791025", auth_token="hghghjghj", assistant="065bbb"):        
        try:
    ...
    def create_agent(
        ...
        speed=1.0,
        twillo_num="+4948996", 
        ssid="ojgojregjorjeogjr", 
        restaurant_fallback="+88016", 
        auth_token="mkdsmklmlkfds", 
        webhook="https://smfdm.ngrok-free.app/vapi-webhook/"
        ):
